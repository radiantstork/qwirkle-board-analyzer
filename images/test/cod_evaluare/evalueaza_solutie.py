...
predictions_path_root = "../../../code/solutions/"

# change this on your machine to point to the ground-truth test
# gt_path_root = "../../../images/test/fake_test/ground-truth/"
gt_path_root = "../../../images/train/"
...
for game in range(1, 6):
    ...
    for move in range(1, 21):
        ...
        print("Image: ", game_move, "Points position: ", points_position, "Points tiles: ", points_tiles,
...
# change this on your machine pointing to your results (txt files)
predictions_path_bonus_root = "../../../code/solutions/bonus/"

# change this on your machine to point to the ground-truth test
gt_path_root_bonus = "../../../images/test/fake_test/ground-truth/bonus/"
# gt_path_root_bonus = "../../../images/train/bonus/"
...
for game in range(1, 2):
    for move in range(1, 21):
        ...
        try:
            points_position, points_tiles, points_score = compare_annotations_bonus(filename_predicted, filename_gt,
                                                                                    verbose)
        except:
            print("For image: ", game_move, " encountered an error")
